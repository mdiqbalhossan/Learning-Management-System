...
<head>
    <title>Pay and Buy Your Course</title>
    <link rel="stylesheet"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="{{ route('stripe.post') }}" method="post" class="validation"
                            ...
                            {{-- <input type="hidden" name="enroll_id" value="{{ Session::get('enroll_id') }}"> --}}
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-danger btn-lg btn-block" type="submit">Pay Now
                                        (${{ Session::get('total_amount'); }})</button>
                                </div>
                                <div class="col-xs-12">
                                    <a href="{{ route('home') }}" class="btn btn-primary my-2 btn-lg btn-block"
                                        type="submit">Back
                                    </a>
                                </div>
                            </div>
