                    ...
                    <article id="post-8" class="post-8 page type-page status-publish hentry">
                        <div class="entry-content">
                            <div class="woocommerce">
                                ...
                                <div class="woocommerce-notices-wrapper"></div>
                                <form name="checkout" method="post" class="checkout woocommerce-checkout row" action="#"
                                                ...
                                                <div class="woocommerce-billing-fields">
                                                    ...
                                                    <div class="woocommerce-billing-fields__field-wrapper">
                                                        <p class="form-row form-row-first form-group validate-required"
                                                            ...
                                                            <label for="billing_first_name" class="control-label">First
                                                        ...
                                                        <p class="form-row form-row-wide address-field update_totals_on_change form-group single-country validate-required"
                                                            id="billing_country_field" data-priority="40">
                                                            <label for="billing_country"
                                                                class="control-label">Country&nbsp;<abbr
                                                                    class="required"
                                                        ...
                                                        <p class="form-row form-row-wide address-field form-group validate-required"
                                                            ...
                                                            <span class="woocommerce-input-wrapper">
                                                                <input type="text"
                                                                    ...
                                                                    value="sss" autocomplete="address-line1"
                                                                    data-placeholder="House number and street name">
                                                            </span>
                                                        </p>
                                                        <p class="form-row form-row-wide address-field form-group"
                                                            id="billing_address_2_field" data-priority="60">
                                                            <label for="billing_address_2"
                                                                class="control-label">Apartment,
                                                        ...
                                                        <p class="form-row form-row-wide address-field form-group validate-required"
                                                            ...
                                                            <label for="billing_city" class="control-label">Town /
                                                            ...
                                                            <span class="woocommerce-input-wrapper"><input type="text"
                                                                    ...
                                                                    value="London" autocomplete="address-level2"></span>
                                                        </p>
                                                        <p class="form-row form-row-wide address-field form-group validate-required validate-state"
                                                            ...
                                                            <label for="billing_state"
                                                                class="control-label">District&nbsp;<abbr
                                                                    class="required"
                                                                    title="required">*</abbr></label><span
                                                                class="woocommerce-input-wrapper">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="cart-subtotal">
                                                        ...
                                                        <td><span class="woocommerce-Price-amount amount"><span
                                                                    class="woocommerce-Price-currencySymbol">৳&nbsp;</span>54.00</span>
                                                        </td>
                                                    </tr>
